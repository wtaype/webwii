    ...
    <section class="ini_hero">
      ...
      <div class="ini_hero_visual">
        <div class="ini_profile_container">
          ...
          <img src="/webwii/v13/logo.webp" alt="${l}" class="ini_profile_img" loading="lazy"/>
