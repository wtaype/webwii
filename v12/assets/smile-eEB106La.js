import{j as s}from"./vendor-gzd0YkcT.js";import{auth as _,db as u}from"./firebase-CkPxCxD6.js";import{m as x,q as S,w as k,c as D,s as j,d as b,b as M,a as N}from"./firebase-C69Prz-Z.js";import{N as c,c as q,a as A,S as I,d,g as T}from"./main-uyFLFgO4.js";import"./main-CYbCrJE3.js";let o=[],m=null,r=null;const C="wi_notas_cache",p=()=>T("wiSmile")||{},H=a=>{try{localStorage.setItem(C,JSON.stringify(a))}catch{}},E=()=>{try{return JSON.parse(localStorage.getItem(C)||"[]")}catch{return[]}},z=()=>{const{nombre:a="",usuario:t="",email:e=""}=p(),i=a||t||e||_.currentUser?.email||"";return`
