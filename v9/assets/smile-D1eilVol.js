import{j as s}from"./vendor-gzd0YkcT.js";import{auth as _,db as u}from"./firebase-Dx3fmS0a.js";import{r as x,q as S,w as k,f as D,s as j,d as b,c as M,b as N}from"./firebase-XdCz69j8.js";import{N as c,f as q,e as A,S as I,h as d,g as T}from"./main-B0xlU5rF.js";import"./main-dQqsAp09.js";let o=[],m=null,r=null;const C="wi_notas_cache",p=()=>T("wiSmile")||{},H=a=>{try{localStorage.setItem(C,JSON.stringify(a))}catch{}},E=()=>{try{return JSON.parse(localStorage.getItem(C)||"[]")}catch{return[]}},z=()=>{const{nombre:a="",usuario:t="",email:e=""}=p(),i=a||t||e||_.currentUser?.email||"";return`
