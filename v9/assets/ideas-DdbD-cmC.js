import{j as i}from"./vendor-gzd0YkcT.js";import{db as p}from"./firebase-Dx3fmS0a.js";import{s as D,d as y,b as S,c as j,e as x,q as C,f as q,o as z}from"./firebase-XdCz69j8.js";import{g as v,N as o,j as m,k as $,m as w,y as T,h as f,s as B}from"./main-B0xlU5rF.js";import"./main-dQqsAp09.js";const u="wii_ideas";let l=[],c=[],n=!!v("wiSmile");const I=r=>(r||"").toLowerCase(),k=r=>r.trim().toLowerCase().replace(/\s+/g,""),A=Array(8).fill('<div class="ide_skel"><div class="ide_skel_img shimmer"></div><div class="ide_skel_t shimmer"></div><div class="ide_skel_s shimmer"></div></div>').join(""),P=()=>`
  <div class="ide_wrap">
