...
// 📦 PREFIJO + MODELO
const P = 'vid';
const modelo = crearModelo({ p: P, coleccion: 'video', icon: 'video' });
    ...
    <div class="mo_card_top">
      ...
      <div class="mo_icon_wrap">
        ${h.img
          ...
          : ''}
        <i class="fas fa-clapperboard" style="${h.img ? 'display:none' : ''}"></i>
      </div>
...
export const render = () => `
  <div class="mo_wrap">
    ${renderTopbar({ p: P, titulo: 'Video con', grad: 'Inteligencia Artificial' })}
  ...
  ${renderModal({ p: P, icon: 'video' })}`;

// ⚙️ INIT / CLEANUP
export const init    = () => { modelo.init(cardHtml); console.log('🎬 Video IA · 2026'); };
export const cleanup = () => { modelo.cleanup();      console.log('🧹 Video'); };