...
// 📦 PREFIJO + MODELO
const P = 'new';
const modelo = crearModelo({ p: P, coleccion: 'nuevos', icon: 'bolt' });
...
export const render = () => `
  <div class="mo_wrap">
    ${renderTopbar({ p: P, titulo: 'Nuevos ', grad: 'Inteligencia Artificial' })}
...
// ⚙️ INIT / CLEANUP
export const init    = () => { modelo.init(cardHtml); console.log('🖼️ Nuevos IA · 2026'); };
export const cleanup = () => { modelo.cleanup();      console.log('🧹 Nuevos'); };