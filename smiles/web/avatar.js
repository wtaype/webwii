...
// 📦 PREFIJO + MODELO
const P = 'ava';
const modelo = crearModelo({ p: P, coleccion: 'avatar', icon: 'user-astronaut' });
    ...
    <div class="mo_card_top">
      ...
      <div class="mo_icon_wrap">
        ${h.img
          ...
          : ''}
        <i class="fas fa-user-astronaut" style="${h.img ? 'display:none' : ''}"></i>
      </div>
...
export const render = () => `
  <div class="mo_wrap">
    ${renderTopbar({ p: P, titulo: 'Avatares con', grad: 'Inteligencia Artificial' })}
  ...
  ${renderModal({ p: P, icon: 'user-astronaut' })}`;

// ⚙️ INIT / CLEANUP
export const init    = () => { modelo.init(cardHtml); console.log('🧑‍🚀 Avatar IA · 2026'); };
export const cleanup = () => { modelo.cleanup();      console.log('🧹 Avatar'); };