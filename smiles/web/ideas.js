...
// 📦 PREFIJO + MODELO
const P = 'ide';
const modelo = crearModelo({ p: P, coleccion: 'ideas', icon: 'lightbulb' });
    ...
    <div class="mo_card_top">
      ...
      <div class="mo_icon_wrap">
        ${h.img
          ...
          : ''}
        <i class="fas fa-lightbulb" style="${h.img ? 'display:none' : ''}"></i>
      </div>
...
export const render = () => `
  <div class="mo_wrap">
    ${renderTopbar({ p: P, titulo: 'Ideas con', grad: 'Inteligencia Artificial' })}
  ...
  ${renderModal({ p: P, icon: 'lightbulb' })}`;

// ⚙️ INIT / CLEANUP
export const init    = () => { modelo.init(cardHtml); console.log('💡 Ideas IA · 2026'); };
export const cleanup = () => { modelo.cleanup();      console.log('🧹 Ideas'); };