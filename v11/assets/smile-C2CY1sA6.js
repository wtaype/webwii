import{j as s}from"./vendor-gzd0YkcT.js";import{auth as _,db as u}from"./firebase-CO18WnsV.js";import{r as x,q as S,w as k,c as D,s as j,d as b,b as M,a as N}from"./firebase-S0i6WGaj.js";import{N as c,k as q,h as A,S as I,b as d,g as T}from"./main-Cj6CcM5e.js";import"./main-DFM23v7O.js";let o=[],m=null,r=null;const C="wi_notas_cache",p=()=>T("wiSmile")||{},H=a=>{try{localStorage.setItem(C,JSON.stringify(a))}catch{}},E=()=>{try{return JSON.parse(localStorage.getItem(C)||"[]")}catch{return[]}},z=()=>{const{nombre:a="",usuario:t="",email:e=""}=p(),i=a||t||e||_.currentUser?.email||"";return`
