    ...
    <section class="ac_hero">
      ...
      <div class="ac_hero_contenido">
        <div class="ac_logo_grande">
          <img src="/webwii/v11/logo.webp" alt="${o}" />
        </div>
...
`,y=()=>{[".ac_feat",".ac_paso",".ac_team_card",".ac_red_card",".ac_valor_card",".ac_mision_card",".ac_tech_item"].forEach(a=>{e(a).each((s,c)=>l(c,()=>e(c).addClass("visible")))}),e('[data-accion="compartir"]').on("click",function(){const a=`💙 ${o}

✨ Frases de Motivación, Reflexión y Fe en Dios
🔗 https://awonbeee.web.app/`;navigator.share?navigator.share({text:a,title:`${o} - Frases Inspiradoras`}).catch(()=>{}):p("https://awonbeee.web.app/",this,"¡Link copiado! ✨")}),console.log(`📖 ${o} ${r} - Acerca cargado`)},w=()=>{e("[data-accion]").off("click"),console.log("🧹 Acerca limpiado")};export{w as cleanup,y as init,$ as render};
